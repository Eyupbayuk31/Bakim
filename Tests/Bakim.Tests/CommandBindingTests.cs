...
public class CommandBindingTests
{
    ...
    public static TheoryData<string, Type> ViewToViewModel() => new()
    {
        ...
        { "Views/Modules/NetworkConnectionsPanel.xaml",  typeof(NetworkMonitorViewModel) },
        { "Views/Modules/NetworkListeningPanel.xaml",    typeof(NetworkMonitorViewModel) },
        { "Views/Modules/NetworkAdaptersPanel.xaml",     typeof(NetworkMonitorViewModel) },
        { "Views/Modules/NetworkSpeedTestPanel.xaml",    typeof(NetworkMonitorViewModel) },
        { "Views/Modules/NetworkDiagnosticsPanel.xaml",  typeof(NetworkMonitorViewModel) },
        ...
        { "Views/Modules/StorageDiskMapPanel.xaml",      typeof(StorageViewModel) },
        { "Views/Modules/StorageLargeFilesPanel.xaml",   typeof(StorageViewModel) },
        { "Views/Modules/StorageDuplicatesPanel.xaml",   typeof(StorageViewModel) },
